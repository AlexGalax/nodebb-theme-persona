...
<div class="row">
	...
	<div class="col-sm-10 col-xs-12">
		<form role="form" class="persona-settings">
			...
			<div class="checkbox">
				<label class="mdl-switch mdl-js-switch mdl-js-ripple-effect">
					<input class="mdl-switch__input" type="checkbox" id="enableAmpSupport" name="enableAmpSupport">
					<span class="mdl-switch__label"><strong>Enable AMP Support</strong></span>
				</label>
			</div>
		</form>
	</div>
