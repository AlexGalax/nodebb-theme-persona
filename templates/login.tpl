...
<div class="row">
	...
	<div class="<!-- IF alternate_logins -->col-md-6<!-- ELSE -->col-md-12<!-- ENDIF alternate_logins -->">
		...
		<div class="login-block panel panel-primary">
			<div class="panel-heading">
				<h4 class="panel-title">[[login:login]]</h4>
			</div>
				...
				<form class="form-horizontal" role="form" method="post" target="login" id="login-form">
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-10">
							...
							<span>[[login:dont_have_account]] <a href="{config.relative_path}/register"><i class="fa fa-arrow-right" aria-hidden="true"></i> [[register:register]]</a></span>
	...
	<div class="<!-- IF allowLocalLogin -->col-md-6<!-- ELSE -->col-md-12<!-- ENDIF allowLocalLogin -->">
		<div class="alt-login-block panel panel-primary">
			<div class="panel-heading">
				<h4 class="panel-title">[[login:alternative_logins]]</h4>
			</div>
			<div class="panel-body">
				<ul class="alt-logins">
